...
if(NBSEUIL == 3) {
CONTAAGG<-merge(CONTAAGG,PARAMETRECONTA[,c("PARAMETRE","NOMCOURT","FAMILLE","VALSEUIL1","VALSEUIL2","VALSEUIL3","SEUIL")],by="PARAMETRE")
} else {
CONTAAGG<-merge(CONTAAGG,PARAMETRECONTA[,c("PARAMETRE","NOMCOURT","FAMILLE","VALSEUIL1","VALSEUIL2","VALSEUIL3","VALSEUIL4","SEUIL")],by="PARAMETRE")
...
#Mise en Classe de qualité
	...
	CONTAAGG$CLASSECONTA[CONTAAGG$RESULTAT2<=CONTAAGG$VALSEUIL1]<-1  
	CONTAAGG$CLASSECONTA[CONTAAGG$RESULTAT2>CONTAAGG$VALSEUIL1 & CONTAAGG$RESULTAT2<=CONTAAGG$VALSEUIL2]<-2  
	CONTAAGG$CLASSECONTA[CONTAAGG$RESULTAT2>CONTAAGG$VALSEUIL2 & CONTAAGG$RESULTAT2<=CONTAAGG$VALSEUIL3]<-3  
	CONTAAGG$CLASSECONTA[CONTAAGG$RESULTAT2>CONTAAGG$VALSEUIL3 ]<-4 
	CONTAAGG$CLASSECONTA[CONTAAGG$LQMAX>CONTAAGG$VALSEUIL3 ]<- -1 
	if (NBSEUIL == 4) {
	CONTAAGG$CLASSECONTA[CONTAAGG$RESULTAT2>CONTAAGG$VALSEUIL4 ]<-5
	CONTAAGG$CLASSECONTA[CONTAAGG$LQMAX>CONTAAGG$VALSEUIL4 ]<- -1	
	}
