...
### Méthode de calcul en fonction de l'année la plus récente ou sur un chronique
...
# ##############################################################################
# ## CHIMIE : comparaison MA
# ## Méthode de calcul du guide de mars 2009 (testé et vérifié avec data AEAG
# ##############################################################################
# # Préparation des valeurs pour calcul de la moyenne - CAS résultat quantifié
# DATACHIM$MOY[DATACHIM$QUANTIFIE=="1"]<-DATACHIM$RESULTAT[DATACHIM$QUANTIFIE=="1"]
# DATACHIM$MOYMIN[DATACHIM$QUANTIFIE=="1"]<-DATACHIM$RESULTAT[DATACHIM$QUANTIFIE=="1"]
...
# # CAS 1 - Comparaison NQEMA dans les conditions où MOY>= LQMAX ou comparaison impossible car LQMAX non dispo car parametre est tjs quantifié sur la station
# CHIMMA$CLASSEMA<-as.numeric(NA)
...
# # CAS 2 - Comparaison NQEMA dans les conditions où MOY<LQMAX
