...
# modifié le 02/02/15 pour calcul sur EQR
	...
	condIBD100<-BIO_MOY$PARAGROUP=="5856" & !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==1 & BIO_MOY$EQRBIO>1.159 # seuil EQR max défini par J.MOY (EQR max sur la période 2011-2013)
	
	BIO_MOY$INDICEBIO[condIBD1]<-round((((BIO_MOY$EQRBIO[condIBD1]-BIO_MOY$INFB[condIBD1])*20)/(1.159-BIO_MOY$INFB[condIBD1]))+80) # seuil max à modifier si nécessaire 
...
# modifié le 02/02/15 pour calcul sur EQR
	...
	condIBG100<-BIO_MOY$PARAGROUP %in% c("5910","6951") & !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==1 & BIO_MOY$EQRBIO>1.358 # seuil EQR max défini par J.MOY (EQR max sur la période 2011-2013)

	BIO_MOY$INDICEBIO[condIBG1]<-round((((BIO_MOY$EQRBIO[condIBG1]-BIO_MOY$INFB[condIBG1])*20)/(1.358-BIO_MOY$INFB[condIBG1]))+80) # seuil max à modifier si nécessaire 
...
#calcul indice IBMR : ajouté le 10/12/14
	...
	condIBMR100<-BIO_MOY$PARAGROUP %in% c("2928") & !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==1 & BIO_MOY$EQRBIO>1.384 # seuil EQR max défini par J.MOY (EQR max sur la période 2011-2013)

	BIO_MOY$INDICEBIO[condIBMR1]<-round((((BIO_MOY$EQRBIO[condIBMR1]-BIO_MOY$INFB[condIBMR1])*20)/(1.384-BIO_MOY$INFB[condIBMR1]))+80) # seuil max à modifier si nécessaire 
