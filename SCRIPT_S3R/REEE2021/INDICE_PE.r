...
#calcul indice 
	condBio1<- !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==1
	condBio2<- !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==2
	condBio3<- !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==3
	condBio4<- !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==4
	condBio5<- !is.na(BIO_MOY$CLASSEBIO) & BIO_MOY$CLASSEBIO==5
